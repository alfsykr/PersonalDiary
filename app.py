...
password = 'sparta'
cxn_str = f'mongodb+srv://test:{password}@cluster0.tklh5pz.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0'
...
def detail(keyword):
    api_key = 'e677ba89-6e50-43d7-bfad-748f355a874f'
